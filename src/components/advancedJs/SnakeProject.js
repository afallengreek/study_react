...
class SnakeProject extends React.Component{
    constructor(props) {
        super(props);
        this.state={
            hidden:true,
    ...
    componentDidMount() {
        ...
        (function () {
            ...
            function Game(map) {
                console.log("4235");
                this.food = new window.Food();//食物对象
                this.snake = new window.Snake();//小蛇对象
                // console.log(this.snake,window.Snake);
                this.map = map;//地图
        ...
        //初始化游戏对象
        var gm = new window.Game(document.querySelector(".map"));
